...
public class Chalk {
    ...
    public static class Blocks {
        public static final Map<DyeColor, Supplier<ChalkMarkBlock>> MARKS = new LinkedHashMap<>();
    ...
    public static class Tags {
        public static final class Items {
            public static final TagKey<Item> CHALKS = TagKey.create(Registries.ITEM, Chalk.resource("chalks"));
            public static final TagKey<Item> C_CHALKS = TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "chalks"));
            public static final TagKey<Item> GLOWINGS = TagKey.create(Registries.ITEM, Chalk.resource("glowings"));

        }
        public static final class Blocks {
            public static final TagKey<Block> CHALK_MARKS = TagKey.create(Registries.BLOCK, Chalk.resource("chalk_marks"));
            public static final TagKey<Block> CHALK_CANNOT_DRAW_ON = TagKey.create(Registries.BLOCK, Chalk.resource("chalk_cannot_draw_on"));
        }
    }
}
