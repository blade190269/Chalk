...
//    }
    ...
    public static BakedQuad convertToFullBright(BakedQuad quad) {
...
//
//        // Rotate the texture
//        int rotationOffset = Config.Client.SYMBOL_ROTATION_OFFSETS.get(symbol).get();
...
//        return faceBakery.bakeQuad(from, to, blockPartFace, texture, facing, new ModelState() {
//            @Override
//            public @NotNull Transformation getRotation() {
//                return Transformation.identity();
//            }
//        }, blockPartRotation, true);
//    }
