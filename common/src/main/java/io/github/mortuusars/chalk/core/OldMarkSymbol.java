...
public enum OldMarkSymbol implements StringRepresentable {
    ...
    public static final Codec<OldMarkSymbol> CODEC = StringRepresentable.fromEnum(OldMarkSymbol::values);
    public static final IntFunction<OldMarkSymbol> BY_ID = ByIdMap.continuous(OldMarkSymbol::ordinal, values(), ByIdMap.OutOfBoundsStrategy.WRAP);
    public static final StreamCodec<ByteBuf, OldMarkSymbol> STREAM_CODEC = ByteBufCodecs.idMapper(BY_ID, OldMarkSymbol::ordinal);
